        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    List<CompetitionCart> lstCompetitionCart = await _db.CompetitionCart.Where(u => u.ApplicationUserId == user.Id).ToListAsync();

                    HttpContext.Session.SetInt32("ssCartCount", lstCompetitionCart.Count);
